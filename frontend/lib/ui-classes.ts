...
export const CARD_STRONG = "cc-card-strong p-3 sm:p-4";

export const LIST_PANEL =
  "divide-y divide-sky-100/90 rounded-xl border border-sky-200/70 bg-white/95 dark:divide-sky-900/50 dark:border-sky-800/45 dark:bg-[#16202A]/75";

export const LIST_ROW_HOVER =
  "block px-3 py-2.5 transition hover:bg-sky-50/80 dark:hover:bg-sky-950/30";

export const SECTION_TITLE =
  "text-sm font-semibold tracking-tight text-zinc-800 dark:text-sky-100";

export const SECTION_SUBTITLE =
  "mt-0.5 text-xs text-zinc-500 dark:text-[#9bb3c7]";

export const SECTION_HEADING_BAR =
  "min-w-0 border-l-2 border-sky-500/80 pl-3 dark:border-sky-400/70";

export const TEXT_MUTED = "text-[11px] text-zinc-500 dark:text-[#9bb3c7]";

export const TEXT_STATS =
  "text-[11px] tabular-nums text-zinc-400 dark:text-[#8fa3b8]";

export const LINK_MORE =
  "inline-flex shrink-0 items-center gap-0.5 rounded-lg border border-sky-200/80 bg-sky-50/80 px-2.5 py-1 text-xs font-semibold text-sky-800 transition hover:border-sky-300 hover:bg-sky-100 dark:border-sky-700/60 dark:bg-sky-950/40 dark:text-sky-200 dark:hover:border-sky-600 dark:hover:bg-sky-900/50";

export const BTN_PRIMARY =
  "inline-flex items-center justify-center rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-500 dark:bg-sky-500 dark:hover:bg-sky-400";

export const BTN_SECONDARY =
  "inline-flex items-center justify-center rounded-lg border border-indigo-200/80 bg-indigo-50/60 px-4 py-2 text-sm font-semibold text-indigo-900 transition hover:border-indigo-300 hover:bg-indigo-100/80 dark:border-indigo-800/55 dark:bg-indigo-950/30 dark:text-indigo-100 dark:hover:border-indigo-600 dark:hover:bg-indigo-950/50";

export const FILTER_CHIP =
  "inline-flex items-center gap-1.5 rounded-lg border border-sky-200/75 bg-sky-50/90 px-2.5 py-1 text-xs font-medium text-zinc-700 dark:border-sky-800/60 dark:bg-sky-950/35 dark:text-sky-100";
